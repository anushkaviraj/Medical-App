...
public class DoctorListTaskForAc extends AsyncTask<AutoCompleteTextView, Integer, List<String>> {

    AutoCompleteTextView lv;

    public Map<String,Integer> doctors = new HashMap<String,Integer>();
    ...
    protected List<String> doInBackground(AutoCompleteTextView... autoCompleteTextViews) {
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                String text = obj.getString("name") + "-" + obj.getString("speciality_name");
                list.add(text);
                doctors.put(text,obj.getInt("id"));
            }
