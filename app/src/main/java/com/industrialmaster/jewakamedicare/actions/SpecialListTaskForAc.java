...
public class SpecialListTaskForAc extends AsyncTask<AutoCompleteTextView, Integer, List<String>> {

    AutoCompleteTextView lv;
    public Map<String,Integer> special = new HashMap<String,Integer>();
    ...
    protected List<String> doInBackground(AutoCompleteTextView... autoCompleteTextViews) {
        ...
        try {
            URL url = new URL("http://idexserver.tk/anushka/channel/speciality/list.php");
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                list.add(text);
                special.put(text,obj.getInt("id"));
            }
